...
$wsdl="http://localhost/DianSinta/hellowsdl.php?wsdl";	//menuliskan letak client yg disimpan di folder C:xampp/htdocs/DianSinta(nama folder yg dibuat)/hellowsdl.php
...
$result = $client->call('hello', array('name' => 'dian'));	//memanggil hasil client
// Check for a fault
