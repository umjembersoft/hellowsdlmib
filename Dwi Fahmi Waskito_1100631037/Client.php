...
$wsdl="http://localhost/dFahmiW/hellowsdl.php?wsdl";        //menuliskan letak client yg disimpan di folder C:xampp/htdocs/dFahmiW (nama folder yg dibuat)/hellowsdl.php
...
$result = $client->call('hello', array('name' => 'dFahmiW'));        //memanggil hasil client
// Check for a fault
