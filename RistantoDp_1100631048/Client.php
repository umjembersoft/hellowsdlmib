...
$wsdl="http://localhost/Tarjo/hellowsdl.php?wsdl";        //menuliskan letak client yg disimpan di folder C:xampp/htdocs/Tarjo (nama folder yg dibuat)/hellowsdl.php
...
$result = $client->call('hello', array('name' => 'Tarjo'));        //memanggil hasil client
// Check for a fault
