...
$wsdl="http://localhost/Riya/hellowsdl.php?wsdl";        //menuliskan letak client yg disimpan di folder C:xampp/htdocs/Riya (nama folder yg dibuat)/hellowsdl.php
...
$result = $client->call('hello', array('name' => 'Riya'));        //memanggil hasil client
// Check for a fault
