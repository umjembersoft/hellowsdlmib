...
$wsdl="http://localhost/Boban/hellowsdl.php?wsdl";        //menuliskan letak client yg disimpan di folder C:xampp/htdocs/Boban (nama folder yg dibuat)/hellowsdl.php
...
$result = $client->call('hello', array('name' => 'Boban'));        //memanggil hasil client
// Check for a fault
