...
$wsdl="http://localhost/haniwsdl/hellowsdl.php?wsdl";        //menuliskan letak client yg disimpan di folder C:xampp/htdocs/haniwsdl(nama folder yg dibuat)/hellowsdl.php
...
$result = $client->call('hello',array('name'=>'Abimanyu'));        //memanggil hasil client
// Check for a fault
