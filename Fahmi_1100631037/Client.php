...
$wsdl="http://localhost/Sobri/hellowsdl.php?wsdl";        //menuliskan letak client yg disimpan di folder C:xampp/htdocs/Sobri (nama folder yg dibuat)/hellowsdl.php
...
$result = $client->call('hello', array('name' => 'Sobri'));        //memanggil hasil client
// Check for a fault
